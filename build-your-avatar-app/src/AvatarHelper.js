...
export function addnewobject(canvas, svgString) {
  fabric.loadSVGFromString(svgStringDict[svgString], (objects, options) => {
  const group = fabric.util.groupSVGElements(objects, options);
  canvas.add(group); // If you're adding to canvas
});
